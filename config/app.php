...
return [
    ...
    */
    ...
    'max_vehicles_per_student'         => (int) env('MAX_VEHICLES_PER_STUDENT', 1),
    'max_vehicles_per_staff'           => (int) env('MAX_VEHICLES_PER_STAFF', 5),
    'renewal_reminder_days'            => env('RENEWAL_REMINDER_DAYS', '30,14,3'),
